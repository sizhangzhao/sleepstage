...
if __name__ == '__main__':
    ...
    cnn = CNNTrainer(4, 16, 8, 16, num_epoch=300, batch_size=64, log_every=5, lr=0.005, dropout_ratio=0.5)
    runner = CNNRNNTrainer(Config.small_channel, Config.large_channel, Config.number_channel, Config.out_size, Config.hidden_size, cnn, 175, num_epoch=100, batch_size=64, log_every=5, lr=0.002, dropout_ratio=0.5)
